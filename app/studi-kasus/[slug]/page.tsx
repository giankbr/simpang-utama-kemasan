    ...
    <main className="bg-white">
      <section className="border-b border-border">
        <div className="max-w-4xl mx-auto px-4 py-10 md:py-14">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mt-3 mb-4 leading-tight">
            {study.title}
          </h1>
      ...
      <section className="max-w-4xl mx-auto px-4 pb-12 md:pb-16">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12 p-5 md:p-6 bg-light-gray rounded-2xl border border-border">
          <div>
        ...
        <div className="mt-12 p-6 md:p-8 bg-light-gray rounded-2xl border border-border">
        ...
        <div className="mt-12 p-6 md:p-8 rounded-2xl bg-[#0c1f3d] text-white flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <h2 className="text-xl md:text-2xl font-bold mb-2">Butuh solusi serupa untuk brand Anda?</h2>
            <p className="text-white/80 text-sm md:text-base">
              Konsultasi gratis dengan tim ahli kemasan Simpang Utama Kemasan.
            </p>
          </div>
          <a
              ...
              {related.map((item) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="font-bold text-foreground mt-2 mb-2 leading-snug">{item.title}</h3>
