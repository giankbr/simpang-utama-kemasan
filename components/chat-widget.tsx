...
export default function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        <div className="w-72 md:w-80 bg-white rounded-2xl shadow-2xl border border-border overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
          ...
          <div className="p-5">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 w-full py-3 btn-3d btn-3d-whatsapp text-sm"
            >
      ...
      >
        {isOpen ? <IconX size={24} stroke={1.5} /> : <IconMessageCircle size={24} stroke={1.5} />}
      </button>
    </div>
  )
}
